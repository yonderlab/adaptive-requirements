...
| [`@kotaio/adaptive-form`](./packages/adaptive-form/)                               | React integration: a `AdaptiveForm` component that renders requirement schemas with pluggable UI components, multi-step flows, and form library adapters.                                 |
